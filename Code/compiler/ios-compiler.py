...
input_folder_path = "/Users/abhjha8/kaggle_competitions/Image2Code/pix2code/datasets/ios/model_result_gui"
output_folder_path = "/Users/abhjha8/kaggle_competitions/Image2Code/pix2code/datasets/ios/model_result_final/"
...
for input_file in os.listdir(input_folder_path):
    ...
    path = input_file[:input_file.find(file_uid)]
    input_file_path = "{}{}.gui".format(path, file_uid)
    output_file_path = "{}{}.storyboard".format(output_folder_path, file_uid)
